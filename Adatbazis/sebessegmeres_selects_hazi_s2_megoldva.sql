...
SELECT name AS 'név', email AS 'Email cím'
FROM owners;

-- 7. Listázd ki a járművek rendszámát és márkáját magyar oszlopnevekkel!
SELECT license_plate AS 'Rendszám', brand AS 'Márka'
From vehicles;

-- 8. Listázd ki a mérések sebességét "Mért sebesség" néven!
SELECT measured_speed AS 'Mért sebesség'
FROM measurements;
...
SELECT *
FROM measurements
WHERE measured_speed BETWEEN 70 AND 90;
...
SELECT *
FROM vehicles
WHERE color = 'fehér' OR color = 'fekete';
